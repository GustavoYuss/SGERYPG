...
public class DataBaseManager {
    ...
    private final String DATABASE_NAME = "jdbc:mysql://127.0.0.1/sgepypg";
    private final String DATABASE_USER = "Gustavo" ;
    private final String DATABASE_PASSWORD = "z21021441.";
